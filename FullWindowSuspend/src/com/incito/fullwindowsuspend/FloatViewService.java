...
//                        Log.d(TAG + " before", "wmParams.x: " + wmParams.x + " wmParams.y : " + wmParams.y );
                        wmParams.x = (int) event.getRawX() - mFloatView.getMeasuredWidth() / 2;
                        // 减25为状态栏的高度
                        wmParams.y = (int) event.getRawY() - mFloatView.getMeasuredHeight() / 2 - 50;
                        // 刷新
                        mWindowManager.updateViewLayout(mFloatLayout, wmParams);
//                        Log.d(TAG + " after", "wmParams.x: " + wmParams.x + " wmParams.y : " + wmParams.y );
                        return true;
                    case MotionEvent.ACTION_UP:
                        mFloatView.setBackgroundResource(R.drawable.circle_cyan);
                        Log.d(TAG + " MotionEvent.ACTION_UP:", "MotionEvent.ACTION_UP: " + isClick);

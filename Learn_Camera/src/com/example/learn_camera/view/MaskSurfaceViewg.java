 ...
 */
package com.example.learn_camera.view;
 ...
 * @description 
 * @author   tianran
 * @createDate Jan 19, 2015
 * @version  1.0
 */
public class MaskSurfaceViewg extends SurfaceView implements 
SurfaceHolder.Callback, Runnable { 
    ...
    public MaskSurfaceViewg(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public MaskSurfaceViewg(Context context, AttributeSet attrs, int defStyle) {
    ...
    public MaskSurfaceViewg(Context context) {
        super(context);
    }
